<%-- 
    Document   : lager
    Created on : 12-04-2017, 10:38:43
    Author     : auron
--%>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-hover">
                                        ...
                                        <%
                                            ...
                                            ArrayList<Item> getAllItem = im.getAllItem();

                                            for (Item item : getAllItem) 
                                            {
                                                out.print("<tr>");
                                                out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showItem' id='" + item.getItem_id() + "'>" + item.getItem_id() + "</a></td>");
                                                out.print("<td>" + item.getItem_name() + "</td>");
                                                out.print("<td>" + item.getItem_price()  + "</td>");
                                                out.print("<td>" + "<a class='btn btn-warning' href='redigermateriale.jsp?mid=" + item.getItem_id() + "'>" + "Rediger" + "</a></td>");
                                                out.print("<td>" + "<a class='btn btn-danger' href='sletmateriale.jsp?mid=" + item.getItem_id() + "'>" + "Slet" + "</a></td>");
                                                out.print("</tr>");
                                            }
