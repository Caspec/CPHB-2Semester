                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading main-color-bg">
                                <h3 class="panel-title">Slet Tilbud</h3>
                            </div>
                            <div class="panel-body">
                                <h2>Er du sikker på at du vil slette dette tilbud? </h2>
                                
                                    <%
                                      int tid = Integer.parseInt(request.getParameter("tid"));
                                      Offer offer = om.getOffer(tid);
                                    %>
                                        <form class="form-inline" method="POST" action="../ControlDeleteOffer">
                                           <table class="table table-striped table-hover"> 
                                                <tr> 
                                                    <th>Tilbud navn: </th>
                                                    <td> <% out.print(offer.getTilbud_name()); %></td>
                                                </tr> 
                                                <tr> 
                                                    <th>Tilbud Billed: </th>
                                                    <td> <% out.print(offer.getTilbud_img()); %> </td>
                                                </tr> 
                                                <tr> 
                                                    <th>Tilbud tekst: </th>
                                                    <td> <% out.print(offer.getTilbud_info()); %> </td>
                                                </tr> 
                                                <tr> 
                                                    <th>Tilbud rabat: </th>
                                                    <td> <% out.print(offer.getTilbud_rabat()); %> </td>
                                                <input type="hidden" name="offerId" value="<% out.print(offer.getTilbud_id()); %>">
                                                </tr> 
                                                <tr>
                                                    <td><input type="submit" class="btn btn-default" value="Slet Tilbud"></td>
                                                </tr>
                                            </table>
                                        </form>
