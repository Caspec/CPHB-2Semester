<%-- 
    Document   : Afdeling
    Created on : Apr 4, 2017, 10:33:13 AM
    Author     : Makemewant
--%>

<%@page import="data.RegionMapper"%>
<%@page import="domain.entity.getRegion"%>
...
<html lang="en">
    <head>
        ...
        <title>Fog Admin | Afdeling</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="afdeling.jsp">Afdeling</a></li>
                    </ul>
                    <!-- Logout -->
        ...
        <section id="breadcrumb">
            <div class="container">
                <ol class="breadcrumb">
                    <li class="active">Fog Afdeling</li>
                </ol>
            </div>
        </section>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading main-color-bg">
                                <h3 class="panel-title">Regioner</h3>
                            </div>
                                ...
                                <form action="">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <th>Region</th>
                                            <th>Info</th>
                                            <th>Antal bestillinger</th>
                                            <th>Se postnummer</th>
                                        </tr> 
                                        <tr>
                                            <td>Region Hovedestaden</td>
                                            <td>Antal bestillinger der ligger i region Hovedestaden</td>
                                            <td> <%out.println(om.getZipRange(1100, 3500)); %> </td>
                                            <td><input type="checkbox" name="Se postnummer" id="CRHovedeStaden" value="Hovedestaden" checked="true"></td>
                                        </tr>
                                        <tr>
                                            <td>Region Sjælland</td>
                                            <td>Antal bestillinger der ligger i region Sjælland</td>
                                            <td> <%out.println(om.getZipRange(3510, 5500)); %> </td>
                                            <td><input type="checkbox" name="Se postnummer" id="CRSjælland" value="Sjælland" checked="true"></td>
                                        </tr>
                                        <tr>
                                            <td>Region Nordjylland</td>
                                            <td>Antal bestillinger der ligger i region Nordjylland</td>
                                            <td> <%out.println(om.getZipRange(5510, 7500)); %> </td>
                                            <td><input type="checkbox" name="se postnummer" id="CRNordJylland" value="Nordjylland" checked="true"></td>
                                        </tr>
                                        <tr>
                                            <td>Region Midtjylland</td>
                                            <td>Antal bestillinger der ligger i region Midtsjælland</td>
                                            <td> <%out.println(om.getZipRange(7510, 9000)); %> </td>
                                            <td><input type="checkbox" name="Se postnummer" id="CRMidtJylland" value="Midtjylland" checked="true"></td>
                                        </tr>
                                        <tr> 
                                            <td> Region Syddanmark</td>
                                            <td> Antal bestillinger der ligger i region SydDanmark</td>
                                            <td> <%out.println(om.getZipRange(9010, 9990)); %> </td>
                                            <td><input type="checkbox" name="se postnummer" id="CRSydDanmark" value="Syddanmark" checked="true"></td>
                        ...
                        <div id="crh" class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Region Hovedestaden</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel-body">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <th>Hovedestaden</th>
                                            <th>Ordre modtaget dato</th>
                                            <th>Postnummer</th>                                          
                                        </tr> 
                                        <%

                                            ArrayList<getRegion> getRegionStartRange1100 = rm.getAllRegionsStartRange1100();

                                            for (getRegion region : getRegionStartRange1100) {
                                                out.print("<tr>");
                                                out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showUser' id='" + region.getUser_id() + "'>" + region.getUser_name() + "</a></td>");
                                                out.print("<td>" + region.getOrder_recived() + "</td>");
                                                out.print("<td>" + region.getUser_zip() + "</td>");
                                                out.print("</tr>");
                        ...
                        <div id="crs" class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Region Sjælland</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel-body">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            ...
                                            <th>Ordre modtaget dato</th>
                                            <th>Postnummer</th>  
                                                <%                                              ArrayList<getRegion> getRegionStartRange3510 = rm.getAllRegionsStartRange3510();

                                                    for (getRegion region : getRegionStartRange3510) {
                                                        out.print("<tr>");
                                                        out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showUser' id='" + region.getUser_id() + "'>" + region.getUser_name() + "</a></td>");
                                                        out.print("<td>" + region.getOrder_recived() + "</td>");
                                                        out.print("<td>" + region.getUser_zip() + "</td>");
                        ...
                        <div id="crn" class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Region Nordjylland</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel-body">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            ...
                                            <th>Ordre modtaget dato</th>
                                            <th>Postnummer</th>    
                                                <%                                                 ArrayList<getRegion> getRegionStartRange5510 = rm.getAllRegionsStartRange5510();

                                                    for (getRegion region : getRegionStartRange5510) {
                                                        out.print("<tr>");
                                                        out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showUser' id='" + region.getUser_id() + "'>" + region.getUser_name() + "</a></td>");
                                                        out.print("<td>" + region.getOrder_recived() + "</td>");
                                                        out.print("<td>" + region.getUser_zip() + "</td>");
                        ...
                        <div id="crm" class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Region Midtjylland</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel-body">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            ...
                                            <th>Ordre modtaget dato</th>
                                            <th>Postnummer</th>    
                                                <%                                                 ArrayList<getRegion> getRegionStartRange7510 = rm.getAllRegionsStartRange7510();

                                                    for (getRegion region : getRegionStartRange7510) {
                                                        out.print("<tr>");
                                                        out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showUser' id='" + region.getUser_id() + "'>" + region.getUser_name() + "</a></td>");
                                                        out.print("<td>" + region.getOrder_recived() + "</td>");
                                                        out.print("<td>" + region.getUser_zip() + "</td>");
                        ...
                        <div id="crsy" class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Region Syddanmark</h3>
                            </div>
                            <div class="panel-body">
                                <div class="panel-body">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            ...
                                            <th>Ordre modtaget dato</th>
                                            <th>Postnummer</th>    
                                                <%                                                 ArrayList<getRegion> getRegionStartRange9010 = rm.getAllRegionsStartRange9010();

                                                    for (getRegion region : getRegionStartRange9010) {
                                                        out.print("<tr>");
                                                        out.print("<td style='font-weight: bold; font-size: large;'>" + "<a href='#' data-toggle='modal' data-target='#showUser' id='" + region.getUser_id() + "'>" + region.getUser_name() + "</a></td>");
                                                        out.print("<td>" + region.getOrder_recived() + "</td>");
                                                        out.print("<td>" + region.getUser_zip() + "</td>");
        ...
        <!-- Modals -->
        <div class="modal fade" id="showUser" tabindex="-1" role="document"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Vis Kunde</h4>
                    </div>
       ...
       <div class="modal fade" id="addItem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <script src="js/showRegioner.js" type="text/javascript"></script>
        <script src="js/showuser.js" type="text/javascript"></script>
    </body>
</html>
