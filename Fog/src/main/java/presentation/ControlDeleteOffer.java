 ...
 * @author stev
 */
@WebServlet(name = "ControlDeleteOffer", urlPatterns = {"/ControlDeleteOffer"})
public class ControlDeleteOffer extends HttpServlet {
...
//        OfferMapper om = new OfferMapper();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ControlDeleteOffer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
